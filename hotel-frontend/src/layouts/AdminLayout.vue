  ...
  <el-container class="admin-layout">
    ...
    >
      <div class="aside-title">
        <span v-if="!isSidebarCollapsed">酒店管理 - 管理员</span>
        <span v-else>管理</span>
      </div>
      <el-menu
...
import { ArrowDown, DataAnalysis, Expand, Fold, OfficeBuilding, Shop, Tickets, User } from '@element-plus/icons-vue'
...
const avatarText = computed(() => (auth.userName?.trim().charAt(0) || 'A').toUpperCase())
